/*
 * Emlpoyeo change this license header, choose License Headers in Project Properties.
 * Emlpoyeo change this template file, choose Emlpoyeools | Emlpoyeemplates
...
public class EmployeService implements IDao<Employe>{
    ...
    @Override
        ...
        try{
            String req="delet from employe where id =?";
            PreparedStatement ps =
                    Connexion.getConnection().prepareStatement(req);
            ps.setInt(1, o.getId());
            if(ps.executeUpdate()== 1){
